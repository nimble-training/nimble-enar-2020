...
The Github site ([https://github.com/nimble-training/nimble-enar-2020](https://github.com/nimble-training/nimble-enar-2020)) is the master repository for materials for the modules; you can also get the individual files from Github. 

If you're not familiar with Git, you can get these materials by simply going to [https://github.com/nimble-training/nimble-enar-2020](https://github.com/nimble-training/nimble-enar-2020) and click on the 'Download ZIP' button in the right side of the window or simply click [here](https://github.com/nimble-training/nimble-enar-2020/archive/master.zip). See also slide 6 in this document for how to get them using Git or from within RStudio.
...
- make a comment in the Zoom chat if you see something interesting you want to share
- ask questions!
...
Simply go to [https://github.com/nimble-training/nimble-enar-2020](https://github.com/nimble-training/nimble-enar-2020) and click on the 'Download ZIP' button in the right side of the window or simply click [here](https://github.com/nimble-training/nimble-enar-2020/archive/master.zip).

## Within RStudio

Within RStudio go to File->New Project->Version Control->Git and enter:

- "Repository URL": https://github.com/nimble-training/nimble-enar-2020
- "Project Directory Name": nimble-enar-2020 (or something else of your choosing)
...
- `git clone https://github.com/nimble-training/nimble-enar-2020`

Then to update from the repository to get any changes we've made:

- `cd /directory/where/you/put/the/repository/nimble-enar-2020`
- `git pull`
...
Here are the modules we'll work through for this short course.
 ...
 - Introduction to NIMBLE (45 minutes)
    1. [Overview of NIMBLE](modules/1_nimble_background_slides.html)
    2. [The BUGS language in NIMBLE](modules/2_bugs_language_slides.html)
    3. [Building a model in NIMBLE](modules/3_build_model_slides.html)
    4. [Running an MCMC](modules/4_run_mcmc_slides.html)
    
 - Customization (60 minutes)
    4. [Customizing an MCMC](modules/5_customizing_mcmc_slides.html)
    6. [User-defined distributions](modules/6_user_dist_slides.html)
    7. [Exercises: customizing an MCMC and writing your own distribution](modules/7_exercises_slides.html)

 - Break (20 minutes)

 - Biostatistics Applications (Bayesian nonparametrics) (75 minutes)
    8. [Case study: Meta-analysis with nonparametric random effects](modules/8_meta_analysis_slides.html)
    9. [Case study: Survival analysis via a semiparametric Accelerated Failure Time (AFT) model](modules/9_survival_analysis_slides.html)
    10. [Reversible jump for variable selection in the AFT model](modules/10_reversible_jump_slides.html)
    
 - Programming in NIMBLE (45 minutes)
    11. [Operating a NIMBLE model](modules/11_operating_model_slides.html)
    12. [Inspecting model structure](modules/12_model_structure_slides.html)
    13. [Writing an algorithm using nimbleFunctions](modules/13_nimbleFunctions_slides.html)
    14. [Writing your own MCMC sampler](modules/14_user_sampler_slides.html)
    15. [Wrap up](modules/modules/15_wrapup_slides.html)
